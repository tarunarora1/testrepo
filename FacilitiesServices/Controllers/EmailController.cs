...
namespace FacilitiesServices.Controllers
{
    ...
    {
        private string SocketLabsApiKey = null;
        private string SocketLabsServerId = null;
        private string SocketLabsUrl = null;
        private string EmailDefaultFrom = null;
        [Route("SendEmail")]
        [HttpPost]
        ...
        [Route("SendEmailForNewClientUsers")]
        [HttpPost]
        ...
        private List<EmailDataForQuoteInvoice> GetEmailDataforUser(Guid UserId, string IsClientVendorOrCustomer)
        {
            try
            {
        ...
        [HttpPost]
        [Route("SendEmailForNewCustomerUsers")]
